---
name: publisher
description: Финализирует одобренную статью bahramovai.com — кладёт HTML в blog/, обновляет листинг, sitemap и счётчик в ARTICLES.md, коммитит. НИКОГДА не запускает publish-article.sh, это делает человек.
...
4. Обнови счётчик статей и список в ARTICLES.md (правило самоактуализации).
