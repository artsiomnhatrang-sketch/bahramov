...
# Промпт собран по правилу префикс-кэша (.claude/rules/prompt-caching.md):
# роль и правила — статический префикс, он одинаков для всех комментариев
# и переиспользуется из кэша; пост и комментарий — динамический хвост в конце.
