...
- локально: фоновый агент `com.bahramovai.threads-watcher` **раз в 15 минут**
  (`scripts/threads-watcher.py --once`), работает пока MacBook включён.
  Было 3 минуты — увеличено 06.09.2026: круглосуточный опрос каждые 3 минуты
  плюс 4 публикации за день дали блокировку аккаунта разработчика Meta
  («обнаружены необычные действия», снялось подтверждением личности).
  Ниже 15 минут не опускать;
