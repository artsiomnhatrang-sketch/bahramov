...
## СДЕЛАНО
- 26 статей в блоге (тематические кластеры: AI-агенты, Instagram-блокировки, Telegram, автоматизация)
- about.html — страница "Обо мне" с JSON-LD Person + FAQPage
- FAQ-секция на главной (index.html) с FAQPage JSON-LD
- BreadcrumbList JSON-LD добавлен во все 26 статей блога
...
## Опубликованные статьи (26 статей)
